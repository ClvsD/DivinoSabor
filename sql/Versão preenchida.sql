...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Abr-2023 às 15:21
...
(39, 'Mateus', 'Noturno', '1200.00', 'Administrador', '2023-04-06', '165.761.206-64', 'mateus@maetus', '(31) 99133-7237', '$2y$10$.otcZJEkUNCmRGrASA2/dufJXAQ0U2z4KjOPQvvc3GCYyVFDSaU1.', '33130-040', 'Santa Luzia', 'São Cosme de Baixo (São Benedito)', 'Rua Pindaré', '287', 'Mateus_1552762831.jpg');
...
(45, '2023-04-06', '2023-04-18', '2691.81', 'Em andamento', 12, 10, 'Casamento Tradicional', 'sim', '4', '3', 'a', '2'),
(46, '2023-04-06', '2023-04-21', '2631.99', 'Cancelado', 39, 10, 'Casamento Tradicional', '2 coxinha resto é kibe', 'Santa Luzia', 'São Cosme de Baixo (São Benedito)', 'Rua Pindaré', '287'),
(47, '2023-04-06', '2023-04-28', '1692.27', 'Concluido', 39, 6, 'Formandos Tradicional', '', 'Belo Horizonte', 'Centro', 'Afonso pena', '1500'),
(48, '2023-04-06', '2023-05-05', '1891.36', 'Em andamento', 39, 7, 'Formandos Tradicional', '', 'Belo Horizonte', 'Savassi', 'Avenida do Contorno', '7777'),
(49, '2023-04-06', '2023-05-05', '5871.08', 'Em andamento', 39, 8, 'Reveillon Premium', '', 'Belo Horizonte', 'Funcionários', 'Praça da Liberdade', '171'),
(50, '2023-04-06', '2023-04-22', '5990.90', 'Em andamento', 12, 1, 'Reveillon Premium', 'muitas observações', 'Belo Horizonte', 'São Bento', 'Avenida Raja Gabaglia', '2671'),
(53, '2023-04-06', '2023-04-20', '3990.90', 'Em andamento', 39, 11, 'Casamento Intermediário', '', 'f', 'f', 'f', '2');
...
--
ALTER TABLE `funcionario`
  MODIFY `id_funcionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de tabela `ticket`
--
ALTER TABLE `ticket`
  MODIFY `id_ticket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
COMMIT;
