...
function toasts(){
    ...
    Command: toastr["info"]("Aqui você pode cadastrar, excluir e alterar os seus funcionários, também é possível filtrar eles para uma busca mais rápida", "Seja bem-vindo ao Gerenciar funcionários")
    ...
    function go_to_page(page) {
        ...
        if (page == "NovoFuncionario"){
        location.href = "../views/cadastro_funcionario/";

        } else if (page == "GestaoProdutos") {
